...
export default function InterventionDetailPage() {
  ...
  // Render interactive component using registry
  const InteractiveComponent = getInterventionComponent(intervention.title);
  if (InteractiveComponent) {
    return <InteractiveComponent intervention={intervention} />;
  }

  // Fallback to standard intervention view (for interventions without interactive components)
